...
<body class="bg-white">
    ...
    <nav class="relative px-4 py-4 flex justify-between items-center bg-white">
        ...
        <ul
            ...
            <li><a class="text-sm text-blue-600 font-bold" href="#">About The Park</a></li>
            <li class="text-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"
                    class="w-4 h-4 current-fill" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li><a class="text-sm text-gray-400 hover:text-gray-500" href="{{ route('dinosaurs.index') }}">Dinosaurs</a>
            </li>
            <li class="text-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"
                    class="w-4 h-4 current-fill" viewBox="0 0 24 24">
            ...
            <li><a class="text-sm text-gray-400 hover:text-gray-500" href="#">Tickets</a></li>
            <li class="text-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"
                    class="w-4 h-4 current-fill" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    {{-- NAVBAR VÉGE --}}
    {{-- Mobile menü --}}
    <div class="navbar-menu relative z-50 hidden duration-500">
        ...
        <nav
            ...
            <div>
                <ul>
                    ...
                    <li class="mb-1">
                        <a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded"
                            href="#">About The Park</a>
                    </li>
                    <li class="mb-1">
                        <a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded"
                            href="{{ route('dinosaurs.index') }}">Dinosaurs</a>
                    </li>
                    <li class="mb-1">
                        <a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded"
                            href="#">Tickets</a>
...
<script>
    let fun = () => {
        document.getElementById("park").classList.add('rotate-[360deg]');
        document.getElementById("park").classList.remove('scale-50');
        document.getElementById("park").classList.add('text-sky-400');
